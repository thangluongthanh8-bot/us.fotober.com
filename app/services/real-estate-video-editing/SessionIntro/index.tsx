    ...
    <>
      ...
      <div className="w-full flex max-md:gap-8 flex-col md:flex-row mb-12">
        <div className="content-left text-left md:w-[50%]">
          <div className="text-xl mb-4 w-full md:w-[345px] lg:w-[450px] text-justify ">
            <p className="text-base lg:text-xl">
              Adding videos to your listings grabs greater attention and piques buyers' interest.
              Perfectly crafted videos can express emotions that still images just can't capture.
              The more details you provide, the better your chances of selling your home.
            </p>
            <p className="text-base lg:text-xl pt-2">
              Get a more authentic, in-the-moment look with our expert video editing services to
              make your listings stand out and sell faster.
            </p>
          </div>
        ...
        <div className="content-right  w-full md:w-[50%]">
          <div className="w-full h-full rounded-[12px] object-contain overflow-hidden">
            <YoutubeEmbed
              videoId="5rVNUNAqGM4"
              className="w-full h-[215px] md:h-full 2xl:h-[300px] rounded-tl-[12px] rounded-tr-[12px] object-cover"
              title="Fotober US"
              opts={{
                playerVars: {
                  autoplay: 0,
