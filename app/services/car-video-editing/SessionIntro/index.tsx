          ...
          <div className="text-xl mb-4 w-full md:w-[345px] lg:w-[450px] text-justify ">
            <Fadein>
              <p className="text-base lg:text-xl">
                Adding videos to your car listings grabs greater attention and piques buyers'
                interest. Perfectly crafted videos can express emotions that still images just can't
                capture. The more details you provide, the better your chances of selling the car
              </p>
            </Fadein>
            <Fadein>
