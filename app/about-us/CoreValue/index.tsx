...
const listCoreValue = [
  {
    ...
    description:
      'Fotober US is dedicated to delivering top-tier photo editing services, striving for perfection in every project.',
  },
  {
    icon: icon2,
  ...
  },
  {
    ...
    description:
      'Fotober US embraces innovation and employs cutting-edge tools to stay at the forefront of the industry. The company is also adaptable, evolving to meet the changing needs and demands of its clients and the market.',
  },
  {
    icon: icon4,
    title: 'Quality and Reliability',
    description:
      'Fotober US prides itself on delivering high-quality results consistently. Clients can rely on Fotober US to meet their editing needs with precision and accuracy.',
  },
  {
    icon: icon5,
    title: 'Efficiency and Speed',
    description:
      'Fotober US values efficiency and speed, recognizing the importance of timely delivery in the fast-paced world of photography and real estate.\n',
  },
  {
    icon: icon6,
    title: 'Affordability',
    description:
      'While maintaining high quality, Fotober US also prioritizes affordability, ensuring that its services are accessible to a wide range of clients, from individual photographers to large corporations.',
  },
]
  ...
  return (
    <div className="container-custom m-auto px-4">
      <h1 className="opacity-0 h-[20px]">
        About Us - Fotober US | Real Estate Photo And Video Editing
      </h1>
